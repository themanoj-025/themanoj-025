...
# Background and border removed to merge with page background
...
parts.append(
    ...
    f'text-anchor="middle">manoj@github: ~$ ./portrait.sh</text>'
)
...
parts.append(
    ...
    f'manoj@github:~$ whoami <tspan fill="{INK}">Manoj Jana</tspan></text>'
)
parts.append(
